...
public class NYPizza implements PizzaFactory {
    ...
    public Pizza createDeluxe() {
        ...
        Pizza newNYDeluxePizza = new Pizza(listToppingsDeluxe, crust, size) {
            @Override
    ...
    public Pizza createBBQChicken() {
        ...
        ArrayList<String> listToppingsBBQChicken = new ArrayList<String>(Arrays.asList("BBQ Chicken", "green pepper",
                "provolone", "cheddar"));
        Pizza newNYCreateBBCChicken = new Pizza(listToppingsBBQChicken, crust, size) {
            @Override
            public boolean add(Object obj) {
                return true;
            }
    ...
    public Pizza createBuildYourOwn() {
        ...
        Pizza newBuildYourOwn = new Pizza(toppings, crust, size) {
            @Override
            public boolean add(Object obj) {
                if (toppings.size() < 7){

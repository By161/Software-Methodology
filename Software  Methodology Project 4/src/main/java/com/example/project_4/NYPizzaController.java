...
public class NYPizzaController {
    ...
    /**
     * Helper method called from the MainController to give this class access to the data from the other classes
     ...
     */
    public void addToOrder() { //get rid of event handler to remove the double click

...
public class testbed {
    public static void main (String[] args){
        ...
        Member newMember1 = new Member("Brandon", "Yuen",  newDate, Location.BRIDGEWATER);
        Member newMember2 = new Member("Lily", "Chang", newDate, Location.BRIDGEWATER);
        ...
        Member newMember3 = new Member("Bob", "May",  newDate, Location.BRIDGEWATER);
        Member newMember4 = new Member("Amanda", "Long", newDate, Location.BRIDGEWATER);
        ...
        Member newMember5 = new Member("Bob", "May",  newDate, Location.BRIDGEWATER);
        Member newMember6 = new Member("Amanda", "May", newDate, Location.BRIDGEWATER);
